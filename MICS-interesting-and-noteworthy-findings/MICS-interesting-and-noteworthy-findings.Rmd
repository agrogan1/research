...
The findings below are drawn from studies using the *Multiple Indicator Cluster Surveys* (MICS) conducted by UNICEF. Data include more than 200,000 families from approximately 60 Low and Middle Income (LMICS) around the world.
