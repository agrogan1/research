...
When studied in global context, across a diverse group of Low and Middle Income Countries (LMICs): 

* There are differences in parenting *behaviors* across countries.
* Physical punishment (spanking) is *consistently associated* with decreases in child socio-emotional development, and particularly with increases in child aggression.
